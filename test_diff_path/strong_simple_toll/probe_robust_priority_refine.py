...
priority = load_module("robust_priority_refine_base", HERE / "probe_robust_priority.py")
base, cal = priority.base, priority.cal
KINDS = ("multiplicative",)
QUANTILES = (0.55, 0.60, 0.65)
BLENDS = (0.40, 0.50, 0.60)
HIGH_WEIGHTS = (0.50, 0.60, 0.70, 0.80)
STEPS = (32, 40)
SECONDARY_BUDGETS = (0.005, 0.010, 0.020)
...
def main():
    ...
    validation_specs = [priority.spec_only(value) for value in small[:24]]
    ...
    frozen = [priority.spec_only(value) for value in validation[:8]]
    ...
    report = {
        "method": "local refinement of robust lexicographic relative-gain routing",
    ...
    path = HERE / "robust_priority_refine.json"
