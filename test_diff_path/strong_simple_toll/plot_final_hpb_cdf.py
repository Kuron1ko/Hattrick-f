...
REPORT = HERE / "final_hpb_level4.json"
LOADS = ("1", "2", "3")
CLASSES = ("High", "Medium", "Low")
SERIES = (("Hattrick", "baseline"), ("Hattrick-HPB · strict ESM", "candidate"))
COLORS = {"Hattrick": "#2F78D4", "Hattrick-HPB · strict ESM": "#F28E2B"}
LINESTYLES = {"Hattrick": "-", "Hattrick-HPB · strict ESM": "--"}
AXES = {
...
def smooth_cdf(samples, left, right, bandwidth):
    span = right - left
...
def main():
    ...
    figure.text(
        0.055,
        0.965,
        "Load-specific Hattrick versus historical path bias and priority-safe recovery · Level-4 snapshots 400–499",
        ha="left",
        color="#596574",
        fontsize=12.5,
    )
    ...
    figure.savefig(HERE / "final_hpb_cdf.png", dpi=210, bbox_inches="tight")
    figure.savefig(HERE / "final_hpb_cdf.pdf", bbox_inches="tight")
    plt.close(figure)
