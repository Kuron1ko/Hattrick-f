...
REPORT = HERE / "final_p8_sar_level4.json"
LOADS = ("1", "2", "3")
CLASSES = ("High", "Medium", "Low")
SERIES = (("Hattrick", "baseline"), ("P8-SAR · strict ESM", "candidate"))
COLORS = {"Hattrick": "#2F78D4", "P8-SAR · strict ESM": "#F28E2B"}
LINESTYLES = {"Hattrick": "-", "P8-SAR · strict ESM": "--"}
AXES = {
...
def main():
    ...
    figure.text(
        0.055,
        0.965,
        "Load-specific Hattrick versus gated eight-step admission refinement · Level-4 snapshots 400–499",
        ha="left",
        color="#596574",
        fontsize=12.5,
    )
    ...
    figure.savefig(HERE / "final_p8_sar_cdf.png", dpi=210, bbox_inches="tight")
    figure.savefig(HERE / "final_p8_sar_cdf.pdf", bbox_inches="tight")
    plt.close(figure)
