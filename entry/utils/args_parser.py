def add_default_args(parser):
    ...
    parser.add_argument("--path_mask", type=int, default=0, help="Enable per-class path masks stored in topologies/path_masks.")
    parser.add_argument("--model_path_override", type=str, default="", help="Optional model path to load during test mode.")
